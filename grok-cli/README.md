...
Grok Build is the xAI CLI: headless JSON mode, the fullscreen TUI/dashboard, and the ACP stdio surface. No official desktop GUI exists in the sources reviewed, so this adapter covers the CLI surface only.
